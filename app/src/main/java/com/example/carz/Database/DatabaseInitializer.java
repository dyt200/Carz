...
class DatabaseInitializer {
    ...
    private static void populateWithTestData(AppDatabase db) {
        ...
        addUser( db,"Ben", "Pocklington", "test@test.com", "testtest", "0791234567", "Route de Test 16, Ayent, Valais, Suisse");
        addUser( db,"Dylan", "Thompson", "dylan@test.com", "testtest","0791234567", "Route de Test 16, Ayent, Valais, Suisse");
        addUser( db,"Cloud", "Strife", "cloud@test.com", "testtest","0791234567", "No. 1, Sector 7, Midgar");
